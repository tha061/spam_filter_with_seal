...
# ==============================================================================
# (Optional) Build Spark from source code
# Spark developers: uncomment the following to make local compilation of Spark
# ==============================================================================
#cd $DEPS_ROOT
#SPARK="SPARK"
#if [ ! -d $SPARK ]; then
#    echo "Installing $SPARK..."
#    git clone https://github.com/SpiRITlab/spark.git $SPARK
#    cd $SPARK
#    git checkout branch-2.3
#    #export MAVEN_OPTS="-Xmx2g -XX:MaxPermSize=512M -XX:ReservedCodeCacheSize=512m"
#    #-pl '!sql/core,!sql/catalyst,!sql/hive'
#    build/mvn -DskipTests package
#    mkdir -p lib
#    cp -R $PROJECT_ROOT_PATH/lib/* lib/
